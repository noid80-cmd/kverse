...
const cyan = {
  glow1: 'rgba(255,111,60,0.22)',
  glow2: 'rgba(255,111,60,0.1)',
  logoGrad: 'linear-gradient(145deg, #0ea5e9 0%, #00d4ff 100%)',
  logoShadow: '0 8px 40px rgba(255,111,60,0.6), 0 0 80px rgba(255,111,60,0.2)',
  btnGrad: 'linear-gradient(135deg, #0ea5e9 0%, #00d4ff 100%)',
  btnShadow: '0 4px 28px rgba(255,111,60,0.5)',
  accent: '#00d4ff',
}
    ...
    <div style={{ position: 'relative', borderRadius: 28, overflow: 'hidden', fontFamily: font }}>
      <div style={{ position: 'absolute', inset: 0, background: '#FFF8E7' }}>
        ...
        <div style={{
          ...
          backgroundImage: 'linear-gradient(rgba(36,28,21,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(36,28,21,0.03) 1px, transparent 1px)',
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '36px 28px 32px' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{ display: 'inline-block', position: 'relative', marginBottom: 16 }}>
            ...
            <div style={{
              ...
              boxShadow: `0 0 0 1px rgba(36,28,21,0.13), ${cyan.logoShadow}`,
              position: 'relative', zIndex: 1,
            }}>
              <div style={{ position: 'absolute', inset: 0, borderRadius: 24, background: 'linear-gradient(135deg, rgba(36,28,21,0.26) 0%, transparent 55%)' }} />
          ...
          <div style={{
            ...
            fontFamily: font,
            background: 'linear-gradient(135deg, #ffffff 0%, rgba(36,28,21,1) 100%)',
            WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
          }}>Krookie</div>
          <div style={{ fontSize: 12, color: 'rgba(36,28,21,0.39)', fontWeight: 500, fontFamily: font }}>
            기획사가 직접 발굴하는 오디션 플랫폼
          </div>
        </div>

        <div style={{
          background: 'rgba(36,28,21,0.04)', borderRadius: 24, padding: '24px 22px',
          border: '1px solid rgba(36,28,21,0.09)', backdropFilter: 'blur(20px)',
        }}>
          <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10,
            padding: '13px 20px', borderRadius: 14, marginBottom: 18,
            background: 'rgba(36,28,21,0.07)', border: '1px solid rgba(36,28,21,0.12)',
            color: '#241C15', fontSize: 14, fontWeight: 600, fontFamily: font,
          }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
            <div style={{ flex: 1, height: 1, background: 'rgba(36,28,21,0.08)' }} />
            <span style={{ fontSize: 11, color: 'rgba(36,28,21,0.26)', fontWeight: 600, fontFamily: font }}>이메일로 로그인</span>
            <div style={{ flex: 1, height: 1, background: 'rgba(36,28,21,0.08)' }} />
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <div style={{ background: 'rgba(36,28,21,0.05)', border: '1px solid rgba(36,28,21,0.1)', borderRadius: 12, padding: '13px 16px', fontSize: 14, color: 'rgba(36,28,21,0.26)', fontFamily: font }}>이메일</div>
            <div style={{ background: 'rgba(36,28,21,0.05)', border: '1px solid rgba(36,28,21,0.1)', borderRadius: 12, padding: '13px 16px', fontSize: 14, color: 'rgba(36,28,21,0.26)', fontFamily: font }}>비밀번호</div>
            <div style={{
        ...
        <div style={{ textAlign: 'center', fontSize: 13, color: 'rgba(36,28,21,0.33)', marginTop: 20, fontFamily: font }}>
...
export default function ColorPreviewPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#03030a', padding: '40px 20px' }}>
      ...
      <p style={{ textAlign: 'center', color: 'rgba(36,28,21,0.26)', fontSize: 12, fontWeight: 600, letterSpacing: 2, marginBottom: 48, textTransform: 'uppercase' }}>
        Font Comparison
      </p>
        ...
        {fonts.map((f) => (
          <div key={f.label}>
            <div style={{ marginBottom: 14, textAlign: 'center' }}>
              ...
              <span style={{ fontSize: 12, color: 'rgba(36,28,21,0.39)', marginLeft: 8 }}>{f.desc}</span>
            </div>

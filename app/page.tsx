...
const t: Record<Lang, {
  ...
  '한국어': {
    ...
    hero: '당신의 재능,\n기획사에게 직접',
    heroSub: '영상 하나로 전국 기획사 담당자에게 노출되세요.\nKpick은 오디션의 새로운 방식입니다.',
    ...
    talentPoints: ['영상 업로드 한 번으로 전국 기획사에 노출', '기획사가 먼저 연락해요', '오디션 공고를 한 곳에서 확인', '관심 표시와 채팅으로 바로 소통'],
    agencyTitle: '검증된 인재를 더 빠르게',
    agencyPoints: ['전국 지망생 영상을 한 곳에서 탐색', '원하는 조건으로 필터링', '관심 표시로 풀 구성', '채팅으로 바로 연락'],
    howTitle: '이렇게 작동해요',
    steps: [
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <section style={{ maxWidth: 1080, margin: '0 auto', padding: '100px 24px 80px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/signup" style={{ background: 'rgba(255,255,255,0.05)', color: '#eeeeff', fontWeight: 700, fontSize: 16, padding: '16px 32px', borderRadius: 16, textDecoration: 'none', border: '1px solid rgba(255,255,255,0.1)' }}>
              {tx.ctaAgency}
            </Link>
          </div>
        </section>

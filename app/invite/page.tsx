...
function InviteContent() {
  ...
  const inputStyle: React.CSSProperties = {
    width: '100%', background: 'rgba(36,28,21,0.05)',
  ...
  if (loading) {
    return (
      <div style={{ minHeight: '100vh', background: '#FFF8E7', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ color: 'rgba(36,28,21,0.52)', fontSize: 14 }}>확인 중...</div>
      </div>
    )
  }
    ...
    return (
      <div style={{ minHeight: '100vh', background: '#FFF8E7', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ color: '#DC2626', fontWeight: 700, fontSize: 16, marginBottom: 8 }}>{pageError}</div>
          <div style={{ color: 'rgba(36,28,21,0.39)', fontSize: 13 }}>관리자에게 새 초대 링크를 요청해주세요</div>
        </div>
      </div>
    )
  }
    ...
    return (
      <div style={{ minHeight: '100vh', background: '#FFF8E7', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ color: 'rgba(36,28,21,0.52)', fontSize: 13 }}>잠시 후 이동합니다...</div>
        </div>
      </div>
    )
  }
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFF8E7', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          <div style={{
            ...
            boxShadow: '0 0 0 1px rgba(255,111,60,0.2), 0 8px 32px rgba(255,111,60,0.25)',
          }}>
            <svg width="50" height="50" viewBox="0 0 100 100">
              <path d="M50 4 L57 43 L96 50 L57 57 L50 96 L43 57 L4 50 L43 43 Z" fill="#FF6F3C" />
            </svg>
          </div>
          <div style={{ fontSize: 13, color: 'rgba(36,28,21,0.52)', marginBottom: 12 }}>Krookie가 초대합니다</div>
          <div style={{ fontSize: 26, fontWeight: 900, color: '#241C15', marginBottom: 4 }}>{agency?.name}</div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div>
              <label style={{ fontSize: 11, color: 'rgba(36,28,21,0.45)', display: 'block', marginBottom: 6, fontWeight: 600, letterSpacing: 0.5 }}>기획사명</label>
              <div style={{ ...inputStyle, color: 'rgba(36,28,21,0.65)', background: 'rgba(36,28,21,0.03)', cursor: 'not-allowed' }}>
                {agency?.name}
              </div>
            </div>

            <div>
              <label style={{ fontSize: 11, color: 'rgba(36,28,21,0.45)', display: 'block', marginBottom: 6, fontWeight: 600, letterSpacing: 0.5 }}>이메일</label>
              <input
      ...
      <style>{`
        input::placeholder { color: rgba(36,28,21,0.26); }
        input:focus { border-color: rgba(255,111,60,0.4) !important; background: rgba(255,111,60,0.05) !important; }
      `}</style>
    </div>
  )
}

...
const t = {
  ...
  auth: {
    ...
    otpSentTo:       ['메일로 6자리 코드를 보냈어요', 'We emailed you a 6-digit code', '6桁のコードをメールで送りました', '已将6位验证码发送到您的邮箱', '已將6位驗證碼寄到您的信箱', 'ส่งรหัส 6 หลักไปที่อีเมลแล้ว', 'Kode 6 digit telah dikirim ke email', 'Đã gửi mã 6 số qua email', 'Ipinadala namin ang 6-digit na code', 'Te enviamos un código de 6 dígitos'],
    otpCode:         ['6자리 코드', '6-digit code', '6桁のコード', '6位验证码', '6位驗證碼', 'รหัส 6 หลัก', 'Kode 6 digit', 'Mã 6 số', '6-digit code', 'Código de 6 dígitos'],
